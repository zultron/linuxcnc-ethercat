...
int lcec_el5021_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t *pdo_entry_regs) {
  ...
  LCEC_PDO_INIT(pdo_entry_regs, slave->alias, slave->index, slave->vid, slave->pid, 0x6001, 0x04, &hal_data->freq_err_pdo_os, &hal_data->freq_err_pdo_bp);
  LCEC_PDO_INIT(pdo_entry_regs, slave->alias, slave->index, slave->vid, slave->pid, 0x6001, 0x05, &hal_data->ampl_err_pdo_os, &hal_data->ampl_err_pdo_bp);
  ...
  LCEC_PDO_INIT(pdo_entry_regs, slave->alias, slave->index, slave->vid, slave->pid, 0x6000, 0x0e, &hal_data->sync_err_pdo_os, &hal_data->sync_err_pdo_bp);
  LCEC_PDO_INIT(pdo_entry_regs, slave->alias, slave->index, slave->vid, slave->pid, 0x6000, 0x10, &hal_data->tx_toggle_pdo_os, &hal_data->tx_toggle_pdo_bp);
